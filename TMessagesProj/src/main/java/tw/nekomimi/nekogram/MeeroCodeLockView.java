...
public class MeeroCodeLockView extends FrameLayout {
    ...
    private void build(Context context) {
        ...
        // --- gradient lock badge ---
        LockBadgeView badge = new LockBadgeView(context);
    ...
    /** Gradient ring + white lock glyph, all theme-accent driven. */
    private class LockBadgeView extends View {
        private final Paint ringPaint = new Paint(Paint.ANTI_ALIAS_FLAG);
        private final Paint fillPaint = new Paint(Paint.ANTI_ALIAS_FLAG);
        private final Drawable lockDrawable;

        LockBadgeView(Context context) {
            super(context);
